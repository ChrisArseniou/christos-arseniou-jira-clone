import {IssueDetailComponent} from '@chris/project/components/issues/issue-detail/issue-detail.component';
import {IssuePriority, IssueStatus, IssueType} from '@chris/interface/issue';
